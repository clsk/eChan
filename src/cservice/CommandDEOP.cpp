...
CommandDEOP::CommandDEOP(Bot* theBot, Client* theSource, const MsgTokenizer& refParameters) : Command(theBot, theSource, refParameters)
{
   Syntax = "/msg " + LocalBot->theClient.GetNickName() + " deop <#channel> [nick1] [nick2] [nickN]";
}

void CommandDEOP::Parser()
{
